...
class CombineCity(object):
    ...
    def __city_combiner(self):
        ...
        # 组合
        with open('city_coms_all.csv', mode='w', encoding='utf-8') as f_city_coms:
        ...
        # 分表
        with open('city_coms_all.csv', mode='r', encoding='utf-8') as f_city_coms_all:
            ...
            for city_coms_start in range(0, count_id, 200000):
                ...
                city_coms_path = os.path.join('city_coms', city_coms_name)
